  ...
  return (
    <section className='flex flex-col items-center justify-center'>
      <div className='mx-auto container mt-24 flex  items-center justify-center text-center'>
        ...
        <div className='container flex flex-col items-center justify-center'>
        <svg className="h-16 w-16 mb-12"  width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <circle cx="12" cy="12" r="9" />  <line x1="9" y1="9" x2="9.01" y2="9" />  <line x1="15" y1="9" x2="15.01" y2="9" />  <circle cx="12" cy="15" r="2" /></svg>
          <h2 className='m-8 md:text-4xl sm:text-3xl text-4xl w-3/4'>
